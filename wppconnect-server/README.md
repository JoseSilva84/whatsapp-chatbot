...
The session data is stored in JSON files in the `tokens/` directory. For example, `junior2.data.json`:

```json
{"config":{"webhook":"http://localhost:5000/webhook","waitQrCode":true,"proxy":null}}
```
